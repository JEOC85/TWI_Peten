...
map.getView().fit([341787.727355, 1746624.709150, 702068.941269, 1976357.887989], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">INDICE DE HUMEDAD TOPOGRAFICA DEPARTAMENTO DE PETÉN</h2>';
        return titleElement;
    })(),
